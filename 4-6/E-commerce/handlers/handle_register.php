...
if(checkrequestmethod('POST')){
    ...
    if(empty($errors)){
        ...
        $data = ['name' => $firstname . ' ' . $lastname , 'email' => $email , 'password' => $password , 'phone' => $phone , 'address' => $address , 'image' => $image_new_name];
        inserttousers($conn,$data);
        $_SESSION['auth'] = ['name' => $firstname . ' ' . $lastname , 'image' => $image_new_name , 'email' => $email , 'password' => $password];
